...
class EmailService:
    ...
    def __init__(self, 
                 access_key_id: str = 'LTAI5tEWSxUf3VTG4c2sumLb',
                 access_key_secret: str = 'qedcGWVWZwK70Scdx0QeOwOIaaJ28h',
                 endpoint: str = 'dm.aliyuncs.com',
                 account_name: str = 'jiashuwanjin@mail.familymemoirs.cn',
                 template_path: str = 'mail_body.html'):
        """
        初始化邮件服务
